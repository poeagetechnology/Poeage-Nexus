...
export default function Aboutus() {
  ...
  return (
    <>
      <Helmet>
        <title>About Us - Poeage Nexus | Our Story & Mission</title>
        <meta name="description" content="Learn about Poeage Nexus - India's trusted manpower supply and HR consultancy company. Discover our journey, mission, values, and the team behind our success." />
      </Helmet>
